 ...
 const [timeStamp,setTimeStamp] = useState<string>('');
  ...
  <NavBar 
    ...
    />
      ...
      {/* Main Content */}
      <div className="flex-1 flex h-screen overflow-auto flex-col">
        {/* Header */}
        <div className="bg-white border-b ml-[2%] border-w-1 border-gray-300 p-4 ">
          <h1 className="text-gray-500 text-sm font-medium">MESSAGES</h1>
        </div>
        ...
        <div className="flex-1 p-4">
          <div className="bg-white rounded-md shadow-sm p-4">
            <div className="mb-4">
              <h2 className="font-medium mb-2 text-[14px]">What do you like to send today?</h2>
              <div className="flex gap-4">
                <label className="flex items-center gap-2">
                  ...
                  />
                  <span className='text-[14px]'>Regular message</span>
                </label>
                <label className="flex items-center gap-2">
                  <input 
                    type="radio" 
                    ...
                    className="w-4 h-4 text-blue-600"
                  />
                  <span className='text-[14px]'>Exam results</span>
                </label>
                <label className="flex items-center gap-2">
                  <input 
                    type="radio" 
                    ...
                    className="w-4 h-4 text-blue-600"
                  />
                  <span className='text-[14px]' >Fee balances</span>
                </label>
              </div>
            </div>
            ...
            <div className="mb-4">
              <div className="text-sm text-gray-500 mb-2 text-[12px]">ADD ATTACHMENTS</div>
              <div className="flex gap-4">
            ...
            <div className="flex justify-between items-center">
              ...
              <div className="flex gap-2">
                <button className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-md flex items-center text-[13px]">
                  <Send size={16} className="mr-2" />
                  Send
                </button>
                <button onClick={()=>setShowCalender(true)} className="bg-gray-100 text-[13px] hover:bg-blue-100 transition duration-200 text-gray-700 px-6 py-2 rounded-md flex items-center">
